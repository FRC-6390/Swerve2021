...
declare type XRReferenceSpaceType = 'local' | 'local-floor' | 'bounded-floor' | 'unbounded';
...
declare interface XRSession extends EventTarget {
    ...
    requestHitTest(ray: XRRay, frameOfReference: XRFrameOfReference): Promise<XRHitResult[]>;
