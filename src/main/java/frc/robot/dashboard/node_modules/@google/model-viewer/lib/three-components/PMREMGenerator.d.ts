...
declare const $allocateTargets: unique symbol;
declare const $sceneToCubeUV: unique symbol;
declare const $equirectangularToCubeUV: unique symbol;
declare const $createRenderTarget: unique symbol;
declare const $setViewport: unique symbol;
declare const $applyPMREM: unique symbol;
declare const $blur: unique symbol;
declare const $halfBlur: unique symbol;
/**
