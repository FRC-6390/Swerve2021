...
`;
    ...
    [(_a = $rendering, _b = $engine, _c = $scene, _d = $renderer, _e = $swapChain, _f = $camera, _g = $view, _h = $ibl, _j = $skybox, _k = $currentAsset, _l = $directionalLight, _m = $canvas, _o = $boundingBox, $initialize)]() {
        const { Filament } = self;
